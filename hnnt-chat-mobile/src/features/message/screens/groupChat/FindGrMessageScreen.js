...
const mockServerMessages = [
    ...
    { id: "2", sender: "Bob", message: "Let's meet tomorrow!" },
    { id: "3", sender: "Charlie", message: "This is an important update." },
    { id: "4", sender: "Alice", message: "Are you coming to the party?" },
    { id: "5", sender: "David", message: "Let's play some games." }
];
