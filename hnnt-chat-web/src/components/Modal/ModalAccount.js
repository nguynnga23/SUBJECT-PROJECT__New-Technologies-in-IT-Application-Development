    ...
    return (
        <>
            <div className="flex-1 overflow-auto relative">
                ...
                <div
                    className="absolute top-44 left-0 w-[80px] h-[80px] rounded-full shadow-lg overflow-hidden ml-6  border-4 border-gray-300 dark:border-gray-700 cursor-pointer"
                ...
                <div
                    ...
                    className="absolute top-56 left-20 w-8 h-8 bg-gray-200 dark:bg-gray-600 border border-gray-400 dark:border-gray-900 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-300"
                >
                ...
                <div className="absolute w-full h-1 bg-gray-200 dark:bg-gray-700 top-60 mt-6"></div>

                <div className="absolute px-6 top-64 mt-3">
                    <p className="font-semibold">Thông tin cá nhân</p>

                    <div className="grid grid-cols-2 gap-x-4 gap-y-2 mt-3 text-sm">
                        <p className="text-gray-500 dark:text-gray-100">Giới tính</p>
                        <p>{userActive?.gender}</p>

                        <p className="text-gray-500 dark:text-gray-100">Ngày sinh</p>
                        <p>{formattedDate}</p>

                        <p className="text-gray-500 dark:text-gray-100">Điện thoại</p>
                        <p>+84 {userActive?.number}</p>
                    </div>

                    <p className="text-gray-500 dark:text-gray-100 mt-3 text-xs">
            ...
            <div className="border-t pt-2 flex justify-center">
                <button
                    onClick={() => setIsType('edit')}
                    className="w-11/12 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md flex items-center justify-center gap-2 p-2 cursor-pointer"
                >
                    <LuPencilLine className="cursor-pointer" />
