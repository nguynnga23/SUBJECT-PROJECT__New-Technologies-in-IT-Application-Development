...
function TabSearchMessage({ data, keyword, scrollToMessage }) {
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p
                                ...
                                dangerouslySetInnerHTML={{ __html: highlightKeyword(r.content, keyword) }}
                            ></p>
...
export default TabSearchMessage;
