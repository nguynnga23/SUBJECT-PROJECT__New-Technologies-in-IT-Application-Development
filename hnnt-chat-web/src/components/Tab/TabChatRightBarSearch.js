    ...
    return (
        <div className="w-1/4 h-screen bg-white border-l min-w-[350px] ">
            ...
            <div className="relative p-4">
                ...
                <input
                    type="text"
                    className="w-full pl-8 pr-3 py-2 border rounded-md focus:border-blue-500 focus:outline-none"
            ...
            <div className="flex items-center gap-2 mt-4 justify-around">
                ...
                <button className="flex items-center gap-2 px-5 py-1.5 border rounded-md text-gray-700 bg-gray-200 hover:bg-gray-100 text-[12px]">
                    <FaUser size={14} />
                    Người gửi
                </button>
                <button className="flex items-center gap-2 px-5 py-1.5 border rounded-md text-gray-700 bg-gray-200 hover:bg-gray-100 text-[12px]">
